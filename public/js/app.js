...
var app = angular.module('app', ['ui.bootstrap', 'controllers.app', 'controllers.categoryIndex', 'controllers.categoryEdit', 'controllers.attributeIndex']);
...
function CategoryEditController($scope, $http) {
    ...
    $scope.getCategory = function () {
        $http.get('/quantri/categories/' + CATEGORY_ID).then(function (response) {
    ...
    $scope.update = function () {
        ...
        $http.put('/quantri/categories/' + CATEGORY_ID, $scope.editCategoryForm).then(function (response) {
    ...
    $scope.getUnassignedAttributes = function () {
        $http.get('/quantri/categories/' + CATEGORY_ID + '/unassigned-attributes').then(function (response) {
    ...
    $scope.attachAttribute = function (attribute) {
        ...
        $http.post('/quantri/categories/' + CATEGORY_ID + '/attributes/' + attribute.id).then(function (response) {
            $scope.refreshData();
    ...
    $scope.detachAttribute = function (attribute) {
        ...
        $http.delete('/quantri/categories/' + CATEGORY_ID + '/attributes/' + attribute.id).then(function (response) {
            $scope.refreshData();
...
function AttributeIndexController($scope, $http) {
    ...
    $scope.refreshData = function () {
        $http.get('/quantri/attributes/listing?q=' + $scope.searchForm.q + '&sorting=' + $scope.searchForm.sorting + '&direction=' + $scope.searchForm.direction + '&page=' + $scope.searchForm.page + '&limit=' + $scope.searchForm.limit).then(function (response) {
    ...
    $scope.store = function () {
        ...
        $http.post('/quantri/attributes', $scope.addAttributeForm).then(function (response) {
            $scope.addAttributeForm = new addAttributeForm();
    ...
    $scope.update = function () {
        ...
        $http.put('quantri/attributes/' + $scope.editingAttribute.id, $scope.editAttributeForm).then(function (response) {
            $scope.editAttributeForm = new editAttributeForm();
            $scope.editingAttribute = null;
    ...
    $scope.loadAttributeOptions = function () {
        $http.get('quantri/attributes/' + $scope.editingOptionsAttribute.id + '/options').then(function (response) {
    ...
    $scope.addOption = function () {
        ...
        $http.post('quantri/attributes/' + $scope.editingOptionsAttribute.id + '/options', $scope.addOptionForm).then(function (response) {
            $scope.addOptionForm = new addOptionForm();
    ...
    $scope.updateOption = function () {
        ...
        $http.put('quantri/attributes/' + $scope.editingOptionsAttribute.id + '/options/' + $scope.editingOption.id, $scope.editOptionForm).then(function (response) {
            $scope.editOptionForm = new editOptionForm();
            $scope.editingOption = null;
