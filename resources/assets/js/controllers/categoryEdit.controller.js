...
function CategoryEditController($scope, $http) {
    ...
    $scope.getCategory = function () {
        $http.get('/quantri/categories/' + CATEGORY_ID)
            .then(response => {
    ...
    $scope.update = function () {
        ...
        $http.put('/quantri/categories/' + CATEGORY_ID, $scope.editCategoryForm)
            .then(response => {
    ...
    $scope.getUnassignedAttributes = function () {
        $http.get('/quantri/categories/' + CATEGORY_ID + '/unassigned-attributes')
            .then(response => {
    ...
    $scope.attachAttribute = function (attribute) {
        ...
        $http.post('/quantri/categories/' + CATEGORY_ID + '/attributes/' + attribute.id)
            .then(response => {
                $scope.refreshData();
    ...
    $scope.detachAttribute = function (attribute) {
        ...
        $http.delete('/quantri/categories/' + CATEGORY_ID + '/attributes/' + attribute.id)
            .then(response => {
                $scope.refreshData();
