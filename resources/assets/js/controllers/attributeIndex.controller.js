...
function AttributeIndexController($scope, $http) {
    ...
    $scope.refreshData = function () {
        $http.get('/quantri/attributes/listing?q=' + $scope.searchForm.q +
    ...
    $scope.store = function () {
        ...
        $http.post('/quantri/attributes', $scope.addAttributeForm)
            .then(response => {
                $scope.addAttributeForm = new addAttributeForm();
    ...
    $scope.update = function () {
        ...
        $http.put('quantri/attributes/' + $scope.editingAttribute.id, $scope.editAttributeForm)
            .then(response => {
                $scope.editAttributeForm = new editAttributeForm();
                $scope.editingAttribute = null;
    ...
    $scope.loadAttributeOptions = function () {
        $http.get('quantri/attributes/' + $scope.editingOptionsAttribute.id + '/options')
            .then(response => {
    ...
    $scope.addOption = function () {
        ...
        $http.post('quantri/attributes/' + $scope.editingOptionsAttribute.id + '/options', $scope.addOptionForm)
            .then(response => {
                $scope.addOptionForm = new addOptionForm();
    ...
    $scope.updateOption = function () {
        ...
        $http.put('quantri/attributes/' + $scope.editingOptionsAttribute.id + '/options/' + $scope.editingOption.id, $scope.editOptionForm)
            .then(response => {
                $scope.editOptionForm = new editOptionForm();
                $scope.editingOption = null;
